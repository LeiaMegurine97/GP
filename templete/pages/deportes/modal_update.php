                    ...
                    <h5 style="background:#21618C; color:white;">&nbsp &nbsp &nbsp DATOS DE LA DEPORTE</h5>
                        ...
                        <div class="col-xs-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="<?php echo $deporte['minjug_depo']?> "onkeypress="return onlyNumberKey(event)" minlegth="1" maxlength="2" name="minjugadores_deporte" required>
                            </div>
                        </div>
                        <div class="col-xs-3">
                            <div class="form-group">
                                <label for="">Max. Jugadores</label>
                                <input type="text" class="form-control" value="<?php echo $deporte['maxjug_depo']?> "onkeypress="return onlyNumberKey(event)" minlegth="1" maxlength="2" name="maxjugadores_deporte" required>
                            </div>
                        </div>
                    </div>
                </div>
